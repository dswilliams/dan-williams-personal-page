...
const Header = () => {
  return (
    <header className="relative pt-16 pb-20 mb-10 overflow-hidden">
      {/* Art Nouveau and Pop Art background styling */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-nouveau-purple/20 to-nouveau-orange/20"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          {/* Name display with appropriate styling */}
          <div className="relative mb-6 inline-block">
            <h1 className="font-playfair font-black text-5xl md:text-7xl relative z-10 animate-fade-in text-gray-800">
              Dan Williams
            </h1>
          </div>
